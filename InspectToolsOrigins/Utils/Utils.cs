...
namespace InspectToolsOrigins.Utils;
...
internal static class Utils
{
    public static float? GetChance(TechType techType)
    {
        ...
        switch (techType)
        {
            ...
            {
                if (Plugin.ModConfig.EnableRandomStasisRifle) chance = Plugin.ModConfig.RandomChanceStasisRifle;
                break;
            }
            ...
            {
                if (Plugin.ModConfig.EnableRandomRepulsionCannon) chance = Plugin.ModConfig.RandomChanceRepulsionCannon;
                break;
            }
