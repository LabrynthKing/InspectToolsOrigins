...
{
    // Config Keybind
    public static GameInput.Button InspectButton = EnumHandler
        .AddEntry<GameInput.Button>("InspectButton_Bind")
        .CreateInput().WithKeyboardBinding(GameInputHandler.Paths.Keyboard.I)
        .WithControllerBinding(GameInputHandler.Paths.Gamepad.DpadRight)
        .AvoidConflicts()
